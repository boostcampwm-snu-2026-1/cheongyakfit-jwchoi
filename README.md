...
내 정보를 등록하고 **민영 아파트 청약 모집공고 PDF**를 올리면, 공고 안의 모든 청약 종류(일반공급 + 특별공급, 기관추천 제외)에 대해 **내가 넣을 수 있는지 / 왜 그런지 / 무엇이 필요한지**를 판정해주는 웹서비스.
...
| [docs/domain/](docs/domain/README.md)        | 청약 도메인 규칙·기준표 (SSoT, 작성 중) — 배경/자격        |
